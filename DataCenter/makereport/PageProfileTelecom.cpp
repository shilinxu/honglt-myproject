...
IMPLEMENT_DYNCREATE(CTelecomProfilePage, CSettingsPage)

BEGIN_MESSAGE_MAP(CTelecomProfilePage, CSettingsPage)
	//{{AFX_MSG_MAP(CTelecomProfilePage)
...
/////////////////////////////////////////////////////////////////////////////
// CTelecomProfilePage property page

CTelecomProfilePage::CTelecomProfilePage(CXMLElement* pXML)
	: CSettingsPage( CTelecomProfilePage::IDD ), m_pXML( pXML )
{
	//{{AFX_DATA_INIT(CTelecomProfilePage)
	//}}AFX_DATA_INIT
}

CTelecomProfilePage::~CTelecomProfilePage()
{
}

void CTelecomProfilePage::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTelecomProfilePage)
...
/////////////////////////////////////////////////////////////////////////////
// CTelecomProfilePage message handlers

BOOL CTelecomProfilePage::OnInitDialog() 
{
...
BOOL CTelecomProfilePage::LoadXML()
{
	CString strValue;
...
void CTelecomProfilePage::OnItemChangedList(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void CTelecomProfilePage::OnAdd() 
{
	CString strValue;
	CXMLAttribute* pAttri = NULL;
...
void CTelecomProfilePage::OnDelete() 
{
