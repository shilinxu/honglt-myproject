...
class AFX_EXT_CLASS CCircuitry;
class AFX_EXT_CLASS CInterlink;
class AFX_EXT_CLASS CPipeline;

class AFX_EXT_CLASS CRegistry;

class AFX_EXT_CLASS CUserWnd;
class AFX_EXT_CLASS CNetworkWnd;
class AFX_EXT_CLASS CWindowManager;
class AFX_EXT_CLASS CSettingsPage;
