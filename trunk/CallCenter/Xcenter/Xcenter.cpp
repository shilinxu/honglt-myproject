...
const TCHAR	gcszWindowName[]	= _T("CallCenter.Xcenter");
const TCHAR	gcszWindowClass[]	= _T("CallCenter.XcenterEx");

BEGIN_MESSAGE_MAP(CXcenterApp, CWinApp)
	//{{AFX_MSG_MAP(CXcenterApp)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CXcenterApp construction

CXcenterApp::CXcenterApp() : m_pMutex( FALSE, gcszWindowName )
{
	m_bInitialized	= FALSE;
}

/////////////////////////////////////////////////////////////////////////////
// CXcenterApp initialization

BOOL CXcenterApp::InitInstance()
{
	CWaitCursor pCursor;
	...
	dlgSplash->Step( _T("网络") );
		if ( m_bInitialized ) m_bInitialized = Network.Setup();
...
/////////////////////////////////////////////////////////////////////////////
// CXcenterApp termination

int CXcenterApp::ExitInstance() 
{
	CWaitCursor pCursor;
...
BOOL CXcenterApp::SetFirstInstance()
{
...
/////////////////////////////////////////////////////////////////////////////
// CXcenterApp help (suppress F1)

void CXcenterApp::WinHelp(DWORD dwData, UINT nCmd) 
{
}

#ifdef _DEBUG	// for debug break
BOOL CXcenterApp::OnIdle(LONG lCount)
{
...
void CXcenterApp::GetVersionNumber()
{
	TCHAR szPath[128];
	DWORD dwSize;
...
TCHAR CXcenterApp::szMessageBuffer[16384];

void CXcenterApp::Message(int nType, UINT nID, ...)
{
...
void CXcenterApp::Message(int nType, LPCTSTR pszFormat, ...)
{
	if ( nType == MSG_DEBUG && ! Settings.General.Debug ) return;
	if ( nType == MSG_TEMP && ! Settings.General.DebugLog ) return;
...
void CXcenterApp::PrintMessage(int nType, LPCTSTR pszLog)
{
...
void CXcenterApp::LogMessage(LPCTSTR pszLog, BOOL bShowTime)
{
	CFile pFile;
	
	if ( pFile.Open( _T("Xcenter.log"), CFile::modeReadWrite ) )
	{
		pFile.Seek( 0, CFile::end );
	}
	else
	{
		if ( ! pFile.Open( _T("Xcenter.log"), CFile::modeWrite|CFile::modeCreate ) ) return;
	}
...
/////////////////////////////////////////////////////////////////////////////
// CXcenterApp database

BOOL CXcenterApp::OpenDatabase()
{
	// 创建进行存取的字符串
...
BOOL CXcenterApp::CloseDatabase()
{
...
/////////////////////////////////////////////////////////////////////////////
// CXcenterApp get error string

CString CXcenterApp::GetErrorString()
{
