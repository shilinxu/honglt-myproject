...
class	__declspec(dllexport) CWindowManager;
class	__declspec(dllexport) CChildWnd;
class	__declspec(dllexport) CTaskPanel;
class	__declspec(dllexport) CTaskBox;
class	__declspec(dllexport) CIconComboCtrl;
class	__declspec(dllexport) CCoolBarCtrl;
class	__declspec(dllexport) CCoolBarItem;
class	__declspec(dllexport) CRegistry;
/*
class	__declspec(dllexport) CChannel;
class	__declspec(dllexport) CUserChannel;
class	__declspec(dllexport) CFilterGraph;
*/
//
// 64-bit type
//
