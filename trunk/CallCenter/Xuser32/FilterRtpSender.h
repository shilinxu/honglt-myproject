...
// Construction
public:
	CRtpSenderFilter(Payload nPayload, WAVEFORMATEX* pwfx, HRESULT *phr);
	CRtpSenderFilter(Payload nPayload, VIDEOINFOHEADER* pvih, HRESULT *phr);
...
private:
	...
	int				SendPayload(BYTE nPayload, BYTE* pBuffer, DWORD nBuffer);
