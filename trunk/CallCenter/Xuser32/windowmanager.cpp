...
BEGIN_MESSAGE_MAP(CWindowManager, CWnd)
	...
	ON_WM_ERASEBKGND()
	ON_WM_PAINT()
	ON_MESSAGE(WM_WINDOWCLEANUP, OnWindowCleanup)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CWindowManager::Remove(CChildWnd* pChild)
{
	...
	PostMessage( WM_WINDOWCLEANUP, (WPARAM)pChild->m_hInstance, 0L );
}
...
LONG CWindowManager::OnWindowCleanup(WPARAM wParam, LPARAM lParam)
{
	FreeLibrary( (HINSTANCE)wParam );
	return 0;
}
