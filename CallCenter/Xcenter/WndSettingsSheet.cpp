...
IMPLEMENT_DYNAMIC(CSettingsSheet, CDialog)

BEGIN_MESSAGE_MAP(CSettingsSheet, CDialog)
...
int CSettingsSheet::DoModal()
{
	...
	CDialog::InitModalIndirect( m_pTemplate, m_pParentWnd );
