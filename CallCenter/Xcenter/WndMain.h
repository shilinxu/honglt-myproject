...
protected:
	...
	afx_msg void OnUpdateWindowDebugLog(CCmdUI* pCmdUI);
	afx_msg void OnWindowDebugLog();
	...
	afx_msg void OnUpdateTabUser(CCmdUI* pCmdUI);
	afx_msg void OnTabUser();
	afx_msg void OnNetworkConnect();
	afx_msg void OnNetworkDisconnect();
	afx_msg void OnUpdateReportMusic(CCmdUI* pCmdUI);
	afx_msg void OnReportMusic();
	afx_msg void OnUpdateTaskPager(CCmdUI* pCmdUI);
	afx_msg void OnTaskPager();
	afx_msg void OnUpdateTaskMail(CCmdUI* pCmdUI);
	afx_msg void OnTaskMail();
	afx_msg void OnUpdateTaskClerk(CCmdUI* pCmdUI);
	afx_msg void OnTaskClerk();
	afx_msg void OnToolsSettings();
	afx_msg void OnToolsProfile();
	afx_msg void OnToolsPresser();
