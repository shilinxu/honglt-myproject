...
BOOL CMeetingSettingsPage::LoadSettings()
{
	...
	strValue = FormatTimeString( pRegistry.GetInt( "Meeting", "TimeOut", 180 ) );
...
*/	
	strValue = pRegistry.GetString( "Meeting", "RecFile" );
	m_wndRecFile.SetWindowText( (LPCTSTR)strValue );
	strValue = pRegistry.GetString( "Meeting", "RecPath" );
...
BOOL CMeetingSettingsPage::EditSettings() 
{
	...
	pRegistry.SetInt( "Meeting", "TimeOut", FormatTimeValue( strValue ) );
/*	
...
*/	
	...
	pRegistry.SetString( "Meeting", "RecFile", strValue );
	m_wndRecPath.GetWindowText( strValue );
	pRegistry.SetString( "Meeting", "RecPath", strValue );
