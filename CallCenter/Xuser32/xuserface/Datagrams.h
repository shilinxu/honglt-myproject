...
public:
	...
	virtual BOOL	JoinMirror(SOCKADDR_IN* pHost, LPCTSTR xUserId);
	CXMLElement*	FormatXML(CXMLElement* pXML);
...
extern XT_EXT_CLASS CDatagrams Datagrams;
